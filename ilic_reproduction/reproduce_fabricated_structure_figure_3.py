...
n = 79-n_angles # we use reverse order to see the print output of the slowest simulation
...
norm_tran_flux = mp.get_fluxes(refl)
...
with open('fabricated_structure_reflectance_60_through_80_angles.npy', 'wb') as f:
    np.save(f, flux_wvl_final)
    np.save(f, normalized_refl_flux_final)
